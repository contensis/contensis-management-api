...
import { FreeTextSearchOperatorTypeEnum, PagedList, QueryAggregations, toQuery } from 'contensis-core-api';
...
describe('Entry Operations', () => {
	...
	describe('Search entries', () => {
		...
		it('with aggregations using a Query instance', async () => {
			...
			let aggregations: QueryAggregations = {
				tags: { field: 'testField' }
			};
			let query = new Contensis.Query(
				Contensis.Op.startsWith('authorName', 'W')
			);
			query.orderBy = Contensis.OrderBy.asc('authorName');
			query.pageIndex = 1;
			query.pageSize = 50;
	...
	describe('Search entries in IE browser', () => {
		...
		it('with query as Object and url length = 2083', async () => {
			...
			let where = [{
				field: 'authorName',
				startsWith:
					'',
			}];
			let aggregations: QueryAggregations = {
				tags: { field: 'testField' }
			};
		...
		it('with query as Object and url length > 2083', async () => {
			...
			let where = [{
				field: 'authorName',
				startsWith:
					'',
			}];
			let aggregations: QueryAggregations = {
				tags: { field: 'testField' }
			};
