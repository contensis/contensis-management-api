...
### Added
- support for *tags* and *taggroups* API

### Changed
- export new *PagedUsageList* type with additional attributes for methods that return lists of entry usage
...
- users: added *excludedGroups* option for listing users of a group, but not if they are from a particular subgroup.
- groups: added *excludedGroups* option for listing groups of a group, but not if they are from a particular subgroup.

## [2.1.7] - 2023-12-08

### Changed

- users: added *zenQL* option for listing users of a group via zenQL
- groups: added *zenQL* option for listing groups of a group via zenQL

## [2.1.6] - 2023-11-23

### Changed

- users: added *zenQL* option for listing users via zenQL
- groups: added *zenQL* option for listing groups via zenQL
...
- redirects: get, create, update, list and delete support added.

## [2.1.3] - 2022-09-20
### Changes
- users: added *optOutOfNotifications* property to a user that will be available in 16.0

## [2.1.2] - 2022-09-13
### Changes
- roles: added support for all permissions types available in Contensis 15.5

## [2.1.1] - 2022-11-01
### Changes
- users: added *isClassic* option for getting a user by id
