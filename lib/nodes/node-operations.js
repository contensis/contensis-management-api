...
class NodeOperations {
    ...
    getRoot() {
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/projects/:projectId/nodes/root', {})
    ...
    get(id) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/projects/:projectId/nodes/:id', {})
            .addOptions(id, 'id')
            .setParams(this.contensisClient.getParams())
            .toUrl();
        return this.contensisClient.ensureAuthenticationToken().then(() => {
    ...
    getByEntryId(entryId) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/projects/:projectId/nodes', { entryId: null })
    ...
    getChildren(idOrOptions) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/projects/:projectId/nodes/:id/children', { language: null })
    ...
    create(node) {
        ...
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/projects/:projectId/nodes/:parentNodeId/children', {})
    ...
    setChildrenOrder(id, childrenIds, language) {
        ...
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/projects/:projectId/nodes/:id/children/order', { language: null })
            .addOptions(id, 'id')
            .setParams(this.contensisClient.getParams())
            .toUrl();
        return this.contensisClient.ensureAuthenticationToken().then(() => {
