...
class ContentTypeOperations {
    ...
    get(idOrOptions) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/projects/:projectId/contenttypes/:id', { versionStatus: null, version: null })
    ...
    list(options = null) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/projects/:projectId/contenttypes', { dataFormat: null, versionStatus: null })
            .addOptions(options)
            .setParams(this.contensisClient.getParams())
    ...
    create(contentType) {
        ...
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/projects/:projectId/contenttypes', {})
            .setParams(this.contensisClient.getParams())
            .toUrl();
        return this.contensisClient.ensureBearerToken().then(() => {
            return this.httpClient.request(url, {
    ...
    update(contentType) {
        ...
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/projects/:projectId/contenttypes/:id', {})
    ...
    invokeWorkflow(contentType, event, data = null) {
        ...
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/projects/:projectId/contenttypes/:id/workflow/events', {})
            .addOptions(contentType.id, 'id')
            .setParams(this.contensisClient.getParams())
            .toUrl();
        return this.contensisClient.ensureBearerToken().then(() => {
