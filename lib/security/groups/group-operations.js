...
class GroupOperations {
    ...
    getUsersInGroup(idOrName, options) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/security/groups/:idOrName/users', !options ? {} : { includeInherited: null, q: null, pageIndex: null, pageSize: null, order: null, zenQL: null })
            .addOptions(idOrName, 'idOrName')
            .addOptions(options)
            .setParams(this.contensisClient.getParams())
    ...
    getChildGroups(idOrName, options) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/security/groups/:idOrName/groups', !options ? {} : { includeInherited: null, q: null, pageIndex: null, pageSize: null, order: null, zenQL: null })
            .addOptions(idOrName, 'idOrName')
            .addOptions(options)
            .setParams(this.contensisClient.getParams())
            .addMappers(listMappers)
