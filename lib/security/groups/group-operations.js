...
class GroupOperations {
    ...
    list(options) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/security/groups', !options ? {} : { q: null, pageIndex: null, pageSize: null, order: null })
            .addOptions(options)
    ...
    create(group) {
        ...
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/security/groups', {})
            .setParams(this.contensisClient.getParams())
            .toUrl();
        return this.contensisClient.ensureBearerToken().then(() => {
            return this.httpClient.request(url, {
    ...
    update(group) {
        ...
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/security/groups/:id', {})
    ...
    addUser(groupId, userId) {
        ...
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/security/groups/:groupId/users/:userId', {})
    ...
    addChildGroup(groupId, childGroupId) {
        ...
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/security/groups/:groupId/childGroups/:childGroupId', {})
            .addOptions(groupId, 'groupId')
    ...
    getGroup(idOrName) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/security/groups/:idOrName', {})
    ...
    getUsersInGroup(idOrName) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/security/groups/:idOrName/users', {})
            .addOptions(idOrName, 'idOrName')
            .setParams(this.contensisClient.getParams())
            .toUrl();
        return this.contensisClient.ensureBearerToken().then(() => {
    ...
    getChildGroups(idOrName) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/management/security/groups/:idOrName/groups', {})
            .addOptions(idOrName, 'idOrName')
            .setParams(this.contensisClient.getParams())
            .toUrl();
        return this.contensisClient.ensureBearerToken().then(() => {
