...
describe('Group Operations', () => {
    describe('Get group', () => {
        beforeEach(() => {
            (0, specs_utils_spec_1.setDefaultSpy)(global, specs_utils_spec_1.defaultGroups[0]);
    ...
    describe('Create group', () => {
        ...
        it('for valid group', async () => {
            ...
            expect(global.fetch.calls.mostRecent().args).toEqual([
                `http://my-website.com/api/security/groups`,
                (0, specs_utils_spec_1.getDefaultFetchRequest)('POST', null, JSON.stringify(specs_utils_spec_1.defaultGroups[0]))
            ]);
            expect(group).not.toBeNull();
            expect(group.id).toEqual(specs_utils_spec_1.defaultGroups[0].id);
        });
    ...
    describe('Update group', () => {
        ...
        it('for valid group', async () => {
            ...
            expect(global.fetch.calls.mostRecent().args).toEqual([
                `http://my-website.com/api/security/groups/${specs_utils_spec_1.defaultGroups[0].id}`,
                (0, specs_utils_spec_1.getDefaultFetchRequest)('PUT', null, JSON.stringify(specs_utils_spec_1.defaultGroups[0]))
            ]);
            expect(group).not.toBeNull();
            expect(group.id).toEqual(specs_utils_spec_1.defaultGroups[0].id);
        });
    ...
    describe('Add user to group', () => {
        ...
        it('for valid group and user', async () => {
            ...
            expect(global.fetch.calls.mostRecent().args).toEqual([
                ...
                (0, specs_utils_spec_1.getDefaultFetchRequest)('PUT')
            ]);
            expect(result).toEqual(null);
        });
    });
    describe('Add users to group', () => {
        ...
        it('for valid group and users', async () => {
            ...
            expect(global.fetch.calls.mostRecent().args).toEqual([
                ...
                (0, specs_utils_spec_1.getDefaultFetchRequest)('POST', false, JSON.stringify(userIds))
            ]);
            expect(result).toEqual(null);
        });
    });
    ...
    describe('Gets users in group', () => {
        ...
        it('by group id with zenQL', async () => {
            let client = Zengenti.Contensis.Client.create((0, specs_utils_spec_1.getDefaultConfig)());
            let users = await client.security.groups.getUsersByGroupId(specs_utils_spec_1.defaultGroups[0].id, { zenQL: 'username="Geoff"' });
            expect(global.fetch.calls.first().args[0]).toEqual((0, specs_utils_spec_1.getDefaultAuthenticateUrl)());
            expect(global.fetch.calls.mostRecent().args).toEqual([
                `http://my-website.com/api/security/groups/${specs_utils_spec_1.defaultGroups[0].id}/users?pageIndex=0&pageSize=25&zenQL=username%3D%22Geoff%22`,
                (0, specs_utils_spec_1.getDefaultFetchRequest)()
            ]);
            expect(users).not.toBeNull();
            expect(users.items.length).toEqual(2);
        ...
        it('by group id with specific options', async () => {
            ...
            expect(global.fetch.calls.first().args[0]).toEqual((0, specs_utils_spec_1.getDefaultAuthenticateUrl)());
            expect(global.fetch.calls.mostRecent().args).toEqual([
                `http://my-website.com/api/security/groups/${specs_utils_spec_1.defaultGroups[0].id}/users?includeInherited=true&order=username&pageIndex=1&pageSize=50`,
                (0, specs_utils_spec_1.getDefaultFetchRequest)()
            ]);
            expect(users).not.toBeNull();
            expect(users.items.length).toEqual(2);
        ...
        it('by group id with an exclusion group', async () => {
            ...
            expect(global.fetch.calls.first().args[0]).toEqual((0, specs_utils_spec_1.getDefaultAuthenticateUrl)());
            expect(global.fetch.calls.mostRecent().args).toEqual([
                `http://my-website.com/api/security/groups/${specs_utils_spec_1.defaultGroups[0].id}/users?excludedGroups=abc&includeInherited=true&order=username&pageIndex=1&pageSize=50`,
                (0, specs_utils_spec_1.getDefaultFetchRequest)()
            ]);
            expect(users).not.toBeNull();
            expect(users.items.length).toEqual(2);
        ...
        it('by group id with many exclusion groups', async () => {
            ...
            expect(global.fetch.calls.first().args[0]).toEqual((0, specs_utils_spec_1.getDefaultAuthenticateUrl)());
            expect(global.fetch.calls.mostRecent().args).toEqual([
                `http://my-website.com/api/security/groups/${specs_utils_spec_1.defaultGroups[0].id}/users?excludedGroups=abc%2Cdef%2Chij&includeInherited=true&order=username&pageIndex=1&pageSize=50`,
                (0, specs_utils_spec_1.getDefaultFetchRequest)()
            ]);
            expect(users).not.toBeNull();
            expect(users.items.length).toEqual(2);
        ...
        it('by group name with specific options', async () => {
            ...
            expect(global.fetch.calls.first().args[0]).toEqual((0, specs_utils_spec_1.getDefaultAuthenticateUrl)());
            expect(global.fetch.calls.mostRecent().args).toEqual([
                `http://my-website.com/api/security/groups/${specs_utils_spec_1.defaultGroups[0].name}/users?includeInherited=true&order=username&pageIndex=1&pageSize=50`,
                (0, specs_utils_spec_1.getDefaultFetchRequest)()
            ]);
            expect(users).not.toBeNull();
            expect(users.items.length).toEqual(2);
    ...
    describe('Gets groups in group', () => {
        ...
        it('by group id with zenQL', async () => {
            let client = Zengenti.Contensis.Client.create((0, specs_utils_spec_1.getDefaultConfig)());
            let groups = await client.security.groups.getChildGroupsByGroupId(specs_utils_spec_1.defaultGroups[0].id, { zenQL: 'name="Test"' });
            expect(global.fetch.calls.first().args[0]).toEqual((0, specs_utils_spec_1.getDefaultAuthenticateUrl)());
            expect(global.fetch.calls.mostRecent().args).toEqual([
                `http://my-website.com/api/security/groups/${specs_utils_spec_1.defaultGroups[0].id}/groups?pageIndex=0&pageSize=25&zenQL=name%3D%22Test%22`,
                (0, specs_utils_spec_1.getDefaultFetchRequest)()
            ]);
            expect(groups).not.toBeNull();
            expect(groups.items.length).toEqual(2);
