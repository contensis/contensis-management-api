...
class UserOperations {
    ...
    list(options) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/security/users', !options ? {} : { q: null, pageIndex: null, pageSize: null, order: null })
            .addOptions(options)
    ...
    create(user) {
        ...
        let url = contensis_core_api_1.UrlBuilder.create('/api/security/users', {})
            .setParams(this.contensisClient.getParams())
            .toUrl();
        return this.contensisClient.ensureBearerToken().then(() => {
            return this.httpClient.request(url, {
    ...
    getUser(idOrNameOrEmail) {
        let url = contensis_core_api_1.UrlBuilder.create('/api/security/users/:idOrNameOrEmail', {})
