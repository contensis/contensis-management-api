...
describe('User Operations', () => {
    ...
    describe('Create user', () => {
        ...
        it('for valid user', async () => {
            ...
            expect(global.fetch.calls.mostRecent().args).toEqual([
                `http://my-website.com/api/security/users`,
                specs_utils_spec_1.getDefaultFetchRequest('POST', null, JSON.stringify(specs_utils_spec_1.defaultUsers[0]))
            ]);
            expect(user).not.toBeNull();
            expect(user.id).toEqual(specs_utils_spec_1.defaultUsers[0].id);
        });
    ...
    describe('Update user', () => {
        ...
        it('for valid user', async () => {
            ...
            expect(global.fetch.calls.mostRecent().args).toEqual([
                `http://my-website.com/api/security/users/${specs_utils_spec_1.defaultUsers[0].id}`,
                specs_utils_spec_1.getDefaultFetchRequest('PATCH', null, JSON.stringify(specs_utils_spec_1.defaultUsers[0]))
            ]);
            expect(user).not.toBeNull();
            expect(user.id).toEqual(specs_utils_spec_1.defaultUsers[0].id);
        });
    ...
    describe('Update user password', () => {
        ...
        it('for valid user', async () => {
            ...
            expect(global.fetch.calls.mostRecent().args).toEqual([
                ...
                specs_utils_spec_1.getDefaultFetchRequest('POST', null, JSON.stringify(requestBody))
            ]);
    ...
    describe('Perform user actions', () => {
        ...
        it('suspend', async () => {
            ...
            expect(global.fetch.calls.mostRecent().args).toEqual([
                ...
                specs_utils_spec_1.getDefaultFetchRequest('POST', false, JSON.stringify({ type: 'suspend' }))
            ]);
            expect(result).toEqual(null);
        });
        it('unsuspend', async () => {
            ...
            expect(global.fetch.calls.mostRecent().args).toEqual([
                `http://my-website.com/api/security/users/${specs_utils_spec_1.defaultUsers[0].id}/actions`,
                specs_utils_spec_1.getDefaultFetchRequest('POST', false, JSON.stringify({ type: 'unsuspend' }))
            ]);
            expect(result).toEqual(null);
        });
        it('unlock', async () => {
            ...
            expect(global.fetch.calls.mostRecent().args).toEqual([
                `http://my-website.com/api/security/users/${specs_utils_spec_1.defaultUsers[0].id}/actions`,
                specs_utils_spec_1.getDefaultFetchRequest('POST', false, JSON.stringify({ type: 'unlock' }))
            ]);
            expect(result).toEqual(null);
        });
    });
