...
class EntryOperations {
    ...
    list(contentTypeIdOrOptions) {
        ...
        if (!contentTypeIdOrOptions || (!(0, contensis_core_api_1.isString)(contentTypeIdOrOptions) && !contentTypeIdOrOptions.contentTypeId)) {
    ...
    search(query) {
        ...
        let payload = Object.assign(Object.assign({}, requestParams), { includeArchived,
            includeDeleted,
            pageSize,
